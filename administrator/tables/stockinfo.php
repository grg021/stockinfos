...
/**
 * stockinfo Table class
 */
class StockinfosTableStockinfo extends JTable
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct('#__stockinfos', 'id', $db);
    }
...
//        }
    ...
    public function store($updateNulls = false)
    {
        ...
        if ($this->id) {
            ...
            // New stockinfo. An stockinfo created and created_by field can be set by the user,
