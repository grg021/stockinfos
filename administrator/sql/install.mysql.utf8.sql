CREATE TABLE IF NOT EXISTS `#__stockinfos` (
 ...
 `AsOfDate` DATE NOT NULL COMMENT 'DATE WHEN DATA WAS CREATED',
  `AsOfTime` TIME NOT NULL COMMENT 'TIME DATA WAS CREATED',
  `open_value` DECIMAL(6,2) NOT NULL COMMENT 'OPEN VALUE',
  `high` DECIMAL(6,2) NOT NULL COMMENT 'HIGH VALUE',
  `low` DECIMAL(6,2) NOT NULL COMMENT 'LOW VALUE',
  `close_value` DECIMAL(6,2) NOT NULL COMMENT 'CLOSE VALUE',
  `volume` VARCHAR(255) NOT NULL  COMMENT 'VOLUME',
  `_abs-cbn` DECIMAL(6,2) NOT NULL COMMENT 'ABS CBN VALUE',
  `_abs-cbn_pdr` DECIMAL(6,2) NOT NULL  COMMENT 'ABS CBN PDR VALUE',
  `fphc` DECIMAL(6,2) NOT NULL  COMMENT 'FPHC VALUE',
  `fphc preferred` DECIMAL(6,2) NOT NULL  COMMENT 'FPHC PREFERRED VALUE',
  `fgen` DECIMAL(6,2) NOT NULL  COMMENT 'FGEN VALUE',
  `edc` DECIMAL(6,2) NOT NULL  COMMENT 'EDC VALUE',
  `meralco` DECIMAL(6,2) NOT NULL  COMMENT 'MERALCO VALUE',
  `rock` DECIMAL(6,2) NOT NULL  COMMENT 'ROCK VALUE',
	
  `benpres` DECIMAL(6,2) NOT NULL  COMMENT 'BENPRES VALUE',
